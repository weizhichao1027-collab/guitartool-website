...
GuitarTool（吉他工具）的全部练习功能均免费，核心工具离线可用、无广告、无需账户。调音、节拍训练、和弦查找和指法卡片分享集中在一起，支持 iPhone、iPad、Apple Watch 与主屏幕小组件。即将推出的 1.1.0 会内置主题展厅五套完整付费主题的素材，仍通过 App Store 分别购买；原有四款基础主题保持免费可见。已购主题无需另行下载素材，可离线使用。
