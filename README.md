...
GuitarTool（吉他工具）的全部练习功能均免费，核心工具离线可用、无广告、无需账户。调音、节拍训练、和弦查找和指法卡片分享集中在一起，支持 iPhone、iPad、Apple Watch 与主屏幕小组件；仅可选完整视觉主题为付费内容。即将推出的 1.1.0 会新增五套付费完整主题：每套可先预览、单独一次购买、永久解锁且无订阅，下载后可离线使用；后续还会持续增加新主题。
