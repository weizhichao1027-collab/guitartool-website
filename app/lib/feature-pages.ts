...
export const zhFeaturePages: LandingPage[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "闪光灯节拍不会拍照、录像或分析画面。GuitarTool 的调音、节拍与和弦等核心练习工具可完全离线使用，无需账户、没有广告与统计 SDK，也不会上传音频；四款基础主题免费，六套付费主题素材内置且购买后可离线使用。后置闪光灯功能取决于兼容 iPhone 硬件；iPad 与 Apple Watch 继续使用各自的节拍器体验。",
