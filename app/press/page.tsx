...
export const metadata: Metadata = {
  ...
  description: "Official GuitarTool press kit with verified product facts, four full introduction videos, downloadable visuals and developer contact information.",
  alternates: { canonical: absoluteUrl("/press/") },
  openGraph: { title: "GuitarTool Official Press Kit", description: "Verified product facts, downloadable visuals, four full introduction videos and official contact information.", url: absoluteUrl("/press/"), type: "website", images: [{ url: absoluteUrl("/en-chord-card-share.webp"), width: 833, height: 1800, alt: "GuitarTool chord card preview" }] },
  twitter: { card: "summary_large_image", title: "GuitarTool Official Press Kit", description: "Verified GuitarTool facts, downloadable product images and videos.", images: [absoluteUrl("/en-chord-card-share.webp")] },
};
  ...
  return (
    <main className="acqPage pressPage" lang="en">
      ...
      <section className="pressStory shell">
        <div><p className="acqEyebrow">CORE PRACTICE WORKFLOW</p><h2>Tune, keep time and share the exact chord shape in one focused toolkit.</h2></div>
        <div><p>The real-time tuner supports standard, Drop D, DADGAD, open, GCEA and chromatic modes, with A4 calibration from 430–446 Hz. The metronome covers 20–500 BPM, 1–12 beats per bar, subdivisions, eighth-note swing, timers, presets and progressive tempo training.</p><p>Guitar and ukulele players can explore 19,244 fingerings, edit and hear the current voicing, then preview, save or share it as a clear chord card. The same focused workflow extends to iPhone, iPad, Apple Watch and three Home Screen widget sizes, with no ads, account or third-party tracking SDK.</p></div>
      </section>
      ...
      <section className="pressVideoSection shell">
        <div className="assetHeading"><p className="acqEyebrow">24-SECOND VERTICAL CUTDOWNS</p><h2>Shorter edits for fast social and App Preview evaluation.</h2><p>English and Simplified Chinese versions use official localized product screens. The 886 × 1920 files remain candidates only and should receive a fresh App Store specification and metadata review before any upload.</p></div>
