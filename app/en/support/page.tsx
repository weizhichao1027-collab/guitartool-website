...
export const metadata: Metadata = {
  ...
  description: "Version 1.1.0 bundles five separately purchasable complete themes. Get help with offline themes, tuning, metronome, widgets, Apple Watch and chord cards.",
