  ...
  return (
    <main className="acqPage chordHub" lang="en">
      ...
      <section className="hubHero shell">
        ...
        <p>Start with 50 essential chord pages. Each one includes three readable positions; GuitarTool adds all {total} {label.toLowerCase()} fingerings, editing, identification and playback.</p>
      </section>
