...
const content = {
  zh: {
    ...
    privacyBody: "GuitarTool 不要求注册，不包含广告或第三方统计 SDK。麦克风只用于本机实时调音；照片权限只在你主动保存和弦卡片时使用；后置闪光灯节拍不调用相机拍摄。主题展厅仅在使用时连接开发者主题服务获取目录与材质，购买由 Apple App Store 与 StoreKit 处理。",
